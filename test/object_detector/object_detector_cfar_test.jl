...
function tp_cfar_test()
    ...
    cfar1 = SARProcessing.two_parameter_constant_false_alarm_rate(image_no_objects,5,3,0.01);
    cfar2 = SARProcessing.two_parameter_constant_false_alarm_rate(image_with_objects,5,3,0.01);
