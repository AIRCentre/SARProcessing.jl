...
"""
phase_ramp(lines::AbstractArray{Int64, 2}, samples::AbstractArray{Int64, 2}, burst_number::Int64, 
...
"""
function phase_ramp(lines::Matrix{T}, samples::Matrix{T}, burst_number::Int64, 
                    k_psi::Float64, dc_coefficient::Vector{Float64}, 
                    dc_tau_0::Float64, fm_coefficient::Vector{Float64}, 
                    fm_tau_0::Float64, f_c::Float64, lines_per_burst::Int64, 
                    number_of_samples::Int64, delta_t_s::Float64, 
                    delta_tau_s::Float64, tau_0::Number, v_s::Float64, c=SPEED_OF_LIGHT_CONSTANT::Real) where T <: Integer
...
"""
phase_ramp(lines::AbstractArray{Int64, 2}, samples::AbstractArray{Int64, 2}, 
...
"""
function phase_ramp(lines::Matrix{T}, samples::Matrix{T}, 
                        burst_number::Int64, meta_data::Sentinel1MetaData, 
